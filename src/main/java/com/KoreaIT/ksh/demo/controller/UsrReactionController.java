...
public class UsrReactionController {
	...
	public String doGoodReaciton(String relTypeCode, int relId, String replaceUri) {
		...
		ResultData rd = reactionPointService.addGoodReactionPoint(rq.getLoginedMemberId(), relTypeCode,
				relId);
	...
	@ResponseBody
	public String doBadReaciton(String relTypeCode, int relId, String replaceUri) {
		boolean actorCanMakeReaction = reactionPointService.actorCanMakeReaction(rq.getLoginedMemberId(), relTypeCode,
				relId);
		...
		reactionPointService.addBadReactionPoint(rq.getLoginedMemberId(), relTypeCode,
				relId);
